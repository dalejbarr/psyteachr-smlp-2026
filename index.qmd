...
- Chandra Reynolds introduced me to "Hierarchical Linear Modeling"
- In 2006 Doug Davidson (MPI-NL) introduced me to `lme4`
...
.dvk <- d_s02[["data"]][d_s02[["event"]] == "VOICE_KEY"]
d_s02[["data"]][d_s02[["event"]] == "VOICE_KEY"] <-
  rnorm(length(.dvk), mean = 800, sd = 40) |> round(0)
d_s02[["data"]][10] <- NA
...
**in the meantime, you can buy tissues in bulk at your local CostCo...**
